...
{
    public partial class AddFoulForm : Form
    {
        private Team team;

        public AddFoulForm(Team team)
        {
            InitializeComponent();
        ...
        private void addFoulButton_Click(object sender, EventArgs e)
        {
            ...
            team.players.Find(p => p.id.ToString() == playersList.SelectedItems[0].SubItems[0].Text).fouls++;
            Close();
        }
    }
}
